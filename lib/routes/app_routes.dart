...
import 'package:facetap/presentation/register_screen/register_screen.dart'; // Import the RegisterScreen
...
class AppRoutes {
  ...
  static const String registerScreen = '/register_screen'; // New route for RegisterScreen
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    registerScreen: (context) => RegisterScreen(), // New route for RegisterScreen
  };
}
