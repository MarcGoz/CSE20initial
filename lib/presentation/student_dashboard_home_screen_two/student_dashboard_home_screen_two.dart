...
class StudentDashboardHomeScreen extends StatefulWidget {
  const StudentDashboardHomeScreen({Key? key}) : super(key: key);

  @override
  _StudentDashboardHomeScreenState createState() => _StudentDashboardHomeScreenState();
}

class _StudentDashboardHomeScreenState extends State<StudentDashboardHomeScreen> {
  String clockInTime = "--:--";
  ...
  Future<void> _updateClockInTime() async {
    setState(() {
      clockInTime = "${DateFormat('h:mm').format(DateTime.now())} ${DateFormat('a').format(DateTime.now()).toLowerCase()}";
    });
  }
